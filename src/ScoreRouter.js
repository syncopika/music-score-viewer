            ...
            <nav className={currMenuState === "hide menu" ? 'naviOn' : 'naviOff'}>
                <h2 className="aboutHeader" onClick={toggleAbout}>about</h2>
                {
                    ...
                    <React.Fragment>
                        ...
                        <p className='about'>disclaimer: some of my arrangements may be awkward and/or nonsensical. I'm sorry in advance and welcome any feedback :) (feel free to make an issue in the GitHub repo for this project). </p>
                    </React.Fragment>
                }
                <hr />
                <h2> score list </h2>
